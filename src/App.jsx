...
export function App() {
  ...
  return (
    submited === false ? (
      ...
      <div className="bg-dark-blue w-fit p-4 rounded-full rounded-2xl mb-4">
        <img src={iconStar} alt="icon star" />
      </div>

      
      
      <h1 className="text-2xl font-bold mb-2.5 ">How did we go?</h1>

      <p className="text-sm text-light-grey mb-6 leading-1">Please let us now how we did with your support request. All feedback is appreciated to help us improve our offering!</p>
      ...
      <button onClick={handleSubmit} className="bg-orange w-full uppercase tracking-1 font-bold rounded-3xl text-sm py-3 hover: bg-white text-orange hover: cursor-pointer">submit</button>
